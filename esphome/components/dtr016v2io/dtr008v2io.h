...
class dtr016v2ioComponent : public Component,
 ...
 protected:
  friend class dtr016v2ioGPIOPin;
...
class dtr016v2ioGPIOPin : public GPIOPin, public Parented<dtr016v2ioComponent> {
 public:
  void setup() override {}
